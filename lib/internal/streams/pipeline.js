...
function pipelineImpl(streams, callback, opts) {
  ...
  function finishOnlyHandleError(err) {
    console.log('finishOnlyHandleError called', err);
  ...
  function finishImpl(err, final) {
    ...
    console.log('finishImpl called with final', final);

    if (!error && !final) {
      console.log('finishImpl early return');
      return;
    }
    ...
    console.log('ac aborted will be called');
    ac.abort();

    if (final) {
      if (!error) {
        console.log('lastStreamCleanup will be called');
        lastStreamCleanup.forEach((fn) => fn());
      }
      console.log('processNextTick will be called');
